...
namespace System {
    internal static partial class SR {
        ...
        internal static global::System.Resources.ResourceManager ResourceManager => s_resourceManager ??=  new global::System.Resources.ResourceManager(typeof(System.Private.CoreLib.Strings));
        ...
        private static string GetResourceString(string name) {
            return ResourceManager.GetString(name, _resourceCulture) ?? $"Please copy \"{name}\" to resources from \"{typeof(System.Private.CoreLib.Strings).AssemblyQualifiedName}\"";
        }
        ...
        internal static string @Arg_MethodAccessException_WithMethodName => GetResourceString("Arg_MethodAccessException_WithMethodName");
        ...
        internal static string @Arg_NoITypeInfo => GetResourceString("Arg_NoITypeInfo");
        /// <summary>Specified TypeLib was invalid because it did not support the ITypeLib interface.</summary>
        internal static string @Arg_NoITypeLib => GetResourceString("Arg_NoITypeLib");
        ...
        internal static string @Argument_BadAttributeOnInterfaceMethod => GetResourceString("Argument_BadAttributeOnInterfaceMethod");
        ...
        internal static string @Argument_InsufficientSpaceToCopyCollection => GetResourceString("Argument_InsufficientSpaceToCopyCollection");
        ...
        internal static string @Argument_ObjIsWinRTObject => GetResourceString("Argument_ObjIsWinRTObject");
        ...
        internal static string @Argument_TypeIsWinRTType => GetResourceString("Argument_TypeIsWinRTType");
        ...
        internal static string @Argument_TypeNotActivatableViaWindowsRuntime => GetResourceString("Argument_TypeNotActivatableViaWindowsRuntime");
        ...
        internal static string @Argument_Unexpected_TypeSource => GetResourceString("Argument_Unexpected_TypeSource");
        ...
        internal static string @Argument_WinRTSystemRuntimeType => GetResourceString("Argument_WinRTSystemRuntimeType");
        ...
        internal static string @ArgumentNull_GUID => GetResourceString("ArgumentNull_GUID");
        ...
        internal static string @ArgumentOutOfRange_IndexLargerThanMaxValue => GetResourceString("ArgumentOutOfRange_IndexLargerThanMaxValue");
        ...
        internal static string @InvalidCast_WinRTIPropertyValueArrayCoersion => GetResourceString("InvalidCast_WinRTIPropertyValueArrayCoersion");
        /// <summary>Object in an IPropertyValue is of type '{0}' with value '{1}', which cannot be converted to a '{2}'.</summary>
        internal static string @InvalidCast_WinRTIPropertyValueCoersion => GetResourceString("InvalidCast_WinRTIPropertyValueCoersion");
        /// <summary>Object in an IPropertyValue is of type '{0}', which cannot be converted to a '{1}'.</summary>
        internal static string @InvalidCast_WinRTIPropertyValueElement => GetResourceString("InvalidCast_WinRTIPropertyValueElement");
        ...
        internal static string @InvalidOperation_CannotRemoveLastFromEmptyCollection => GetResourceString("InvalidOperation_CannotRemoveLastFromEmptyCollection");
        ...
        internal static string @InvalidOperation_CollectionBackingDictionaryTooLarge => GetResourceString("InvalidOperation_CollectionBackingDictionaryTooLarge");
        /// <summary>The collection backing this List contains too many elements.</summary>
        internal static string @InvalidOperation_CollectionBackingListTooLarge => GetResourceString("InvalidOperation_CollectionBackingListTooLarge");
        ...
        internal static string @InvalidOperation_EventTokenTableRequiresDelegate => GetResourceString("InvalidOperation_EventTokenTableRequiresDelegate");
        ...
        internal static string @NotSupported_AppX => GetResourceString("NotSupported_AppX");
        ...
        internal static string @NotSupported_CollectibleWinRT => GetResourceString("NotSupported_CollectibleWinRT");
        ...
        internal static string @NotSupported_PIAInAppxProcess => GetResourceString("NotSupported_PIAInAppxProcess");
        ...
        internal static string @PlatformNotSupported_WinRT => GetResourceString("PlatformNotSupported_WinRT");
        ...
        /// <summary>The callback populated its buffer with ill-formed UTF-8 data. Callbacks are required to populate the buffer only with well-formed UTF-8 data.</summary>
        internal static string @Utf8String_CallbackProvidedMalformedData => GetResourceString("Utf8String_CallbackProvidedMalformedData");
        /// <summary>The input buffer contained ill-formed UTF-16 data.</summary>
        internal static string @Utf8String_InputContainedMalformedUtf16 => GetResourceString("Utf8String_InputContainedMalformedUtf16");
        /// <summary>The input buffer contained ill-formed UTF-8 data.</summary>
        internal static string @Utf8String_InputContainedMalformedUtf8 => GetResourceString("Utf8String_InputContainedMalformedUtf8");
        /// <summary>Cannot create the desired substring because it would split a multi-byte UTF-8 subsequence.</summary>
        internal static string @Utf8String_CannotSplitMultibyteSubsequence => GetResourceString("Utf8String_CannotSplitMultibyteSubsequence");
        /// <summary>Cannot call Utf8Span.Equals(object). Use Equals(Utf8Span) or operator == instead.</summary>
        internal static string @Utf8Span_CannotCallEqualsObject => GetResourceString("Utf8Span_CannotCallEqualsObject");
        /// <summary>UTF-16 surrogate code points (U+D800..U+DFFF) are disallowed.</summary>
        internal static string @ArgumentOutOfRange_Utf16SurrogatesDisallowed => GetResourceString("ArgumentOutOfRange_Utf16SurrogatesDisallowed");
        /// <summary>Argument cannot be an empty span.</summary>
        internal static string @Argument_CannotBeEmptySpan => GetResourceString("Argument_CannotBeEmptySpan");
        /// <summary>Argument cannot be null or empty.</summary>
        internal static string @Argument_CannotBeNullOrEmpty => GetResourceString("Argument_CannotBeNullOrEmpty");
