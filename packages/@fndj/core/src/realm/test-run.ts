// import { enableLogging, logger } from "@rhombus-toolkit/type-helpers";
...
// import { insertTrack } from './api';



// let _counter = 169;

// const eventSourceData = [{ "type": "create", "author": "philcoulson", "data": { "title": "new user account", "description": "Create a new user account for captain america", "status": "open", "assignee": "shield-support" } }, { "type": "update", "author": "shield-support", "data": { "title": "new user account", "comment": "please include the required priviledds", "status": "in progress" } }, { "type": "update", "author": "philcoulson", "data": { "description": "Create a new user account for captain america. needs access to create and update tickets", "comment": "Descriptiono updated" } }, { "type": "update", "author": "shield-support", "data": { "comment": "Task is done. Please verify", "status": "in review", "assignee": "philcoulson" } }, { "type": "update", "author": "philcoulson", "data": { "comment": "Access verified. Closinig the ticking", "status": "closed" } }]
// const sampleData = [
