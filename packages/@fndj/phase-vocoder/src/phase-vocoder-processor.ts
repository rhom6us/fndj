...
registerProcessor(
  ...
  class extends OverlapAddProcessor {
    ...
    readonly fft: FFT;
    readonly freqComplexBuffer: ComplexArray;
    readonly freqComplexBufferShifted: ComplexArray;
    readonly timeComplexBuffer: ComplexArray;
    readonly magnitudes: Float32Array;
    readonly peakIndexes: Int32Array;
