 ...
 */
export declare type Store<TState = any, TAction extends StandardEventAny = StandardEventAny> = ReduxStore<TState, TAction>;
export declare type Dispatch<TEvent extends StandardEventAny = StandardEventAny> = Store<any, TEvent>['dispatch'];
