...
export default class Timeline {
    ...
    _tracks: TrackCollection;
    _state: any;
    _surfaceCtor: typeof Surface;
    _trackById: {};
    _groupedLayers: {};
     ...
     *    of the timeline).
     */
    addLayer(layer: any, trackOrTrackId: (Track | string), groupId?: string, isAxis?: boolean): void;
    /**
