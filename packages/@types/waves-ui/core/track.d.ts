...
export default class Track {
     ...
     */
    constructor($el: Element, height?: number);
     ...
     */
    renderingContext: TimelineTimeContext;
    /**
     ...
     */
    private configure(renderingContext: TimelineTimeContext);
    /**
     ...
     */
    update(layers?: Array<Layer>): void;
    /**
     ...
     * @param {Array<Layer>} [layers=null] - if not null, a subset of the layers to update.
     */
    updateLayers(layers?: Array<Layer>): void;
    /**
