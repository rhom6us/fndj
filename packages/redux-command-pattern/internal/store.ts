...
export type Dispatch<TAction extends StandardEventAny = StandardEventAny> = Func<TAction>;//<T extends A>(action: T) => void;
 ...
 */
export interface Store<TState = any, TAction extends StandardEventAny = StandardEventAny> {
  /**
