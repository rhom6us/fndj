import { Drop, Length, PartialList, Tail } from './type-helpers/array';
import { Inc } from './type-helpers/counter';

type _CurryBasic<TArgs extends any[], TReturn> =
    <T extends PartialList<TArgs>>(...args: T) =>
        Drop<Length<T>, TArgs> extends [] ? TReturn : _CurryBasic<Drop<Length<T>, TArgs>, TReturn>;
...
const testr: number = testc(R.__, true)("asdf")(new Date());
